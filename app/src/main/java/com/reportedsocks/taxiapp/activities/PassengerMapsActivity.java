...
import com.reportedsocks.taxiapp.BuildConfig;
...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private DatabaseReference usersDatabaseReference, locationDatabaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookTaxiButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                bookTaxiButton.setText("Looking for your taxi...");
        ...
        locationDatabaseReference = database.getReference().child("drivers_geofire");
    ...
    private void getNearestTaxi() {
        ...
        GeoQuery geoQuery = geoFire.queryAtLocation( new GeoLocation(
                currentLocation.getLatitude(), currentLocation.getLongitude()),searchRadius);
    ...
    private void getNearestDriverLocation() {
        ...
        locationDatabaseReference.child(nearestDriverId).child("l").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    bookTaxiButton.setOnClickListener(null);
                }
            }
